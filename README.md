...
The main contributors of IDR-GPU code:
  ...
  * Nathan Boley - Anshul Kundaje Lab, Dept. of Genetics, Standord University
  * J. Seth Strattan    - J. Michael Cherry Lab, Dept. of Genetics, Stanford University
  * Anshul Kundaje      - Assistant Professor, Dept. of Genetics, Stanford University

### Issues

If you notice any problem with the code, please file an issue over [here](https://github.com/nikhilRP/idr/issues)
